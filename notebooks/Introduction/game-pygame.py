...
def game_over():
    ...
    while True:
        ...
        # restart
        if width - 180 < mouse1[0] < width - 100 and height - 100 < mouse1[
                1] < height - 80:
...
def game(
    ...
    while True:
        ...
        if lead_y <= e_p[1] + enemy_size <= lead_y + 40 and lead_x <= e_p[
                0] <= lead_x + 40:
            game_over()
        ...
        if lead_x <= e1_p[0] <= lead_x + 40 and lead_y >= e1_p[
                1] >= lead_y - 40:
            e1_p[0] = width + 100
            e1_p[1] = random.randint(40, height - 40)
            count += 1
            speed += 1
        if lead_y <= e1_p[1] + enemy_size <= lead_y + 40 and lead_x <= e1_p[
                0] <= lead_x + 40:
            e1_p[0] = width + 100
            e1_p[1] = random.randint(40, height - 40)
        ...
        pygame.draw.rect(screen, blue,
                         [e1_p[0], e1_p[1], enemy_size, enemy_size])
        ...
        if x < mouse[0] < x + width1 and y < mouse[1] < y + height1:
            ...
            if x < mouse[0] < x + width1 + 40 and y + 70 < mouse[1] < y \
             + 70 + height1:
                ...
                if x < mouse[0] < width1 + x and y + 140 < mouse[
                        1] < y + 140 + height1:
                    pygame.draw.rect(screen, startl,
